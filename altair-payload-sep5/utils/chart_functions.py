...
its own -- presigned download URLs, the interactive studio editor,
render-failure alerting, and the GS font root -- by registering them on the
core, and re-exports the full public API so every existing caller is
unaffected.
