...
|---------|----------|-----------------------|----------------|-------------------|------|-------------|------------------------|
| altair | mature + tables surface landed (2026-05-12) | `projects/altair/` | `projects/altair/altair-payload/` | `mcp/utils/chart_functions.py` + `context/modules/static/chart_context.md` (hub) + `chart_context_grids.md` + `chart_context_tables.md` (2 spokes) | `.cursor/rules/viz-platforms.mdc` | `code-sandbox.md`, `mcp-utils.md`, `vision-qc.md`, `mcp-tools.md` §3+§5 | `projects/altair/dev/specs/composites.md` (next feature build); `staging/prompts/open/2026-05-12_make_table_namespace_injection.md` (PRISM-side `make_table` namespace wiring) |
