...
| apis | 5 PRISM-shape clients (treasury / treasury_direct / bis / statcan / bank_of_canada), rule codified, Session 8 in flight + Canada coverage added 2026-05-30 | `projects/apis/` | `projects/apis/apis-payload/clients/*.py` + `apis-payload/modules/*.md` | `mcp/clients/*_client.py` + `context/modules/static/{data_guides,instruments,tools}/*.md` | `.cursor/rules/api-clients.mdc` | `gs-proxy.md`, `api-clients.md`, `data-functions.md` §0 | `projects/apis/dev/endeavors/apis_endeavor.md` (8-session plan) |
