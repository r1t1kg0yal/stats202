...
│                                       stamping (own prompt)         │
│  apis         ████████████████████  13 PRISM-shape (treasury,        │
│                                       treasury_direct, bis, statcan,  │
│                                       bank_of_canada, wid,            │
│                                       ai_buildout, ilo, imf, + the    │
│                                       2026-07-08 global-stats batch:  │
│                                       oecd, eurostat, boj, chinadata) │
...
| apis | 13 PRISM-shape clients (treasury / treasury_direct / bis migrated; statcan / bank_of_canada / wid / ai_buildout / ilo / imf / oecd / eurostat / boj / chinadata net-new), rule codified, Session 8 in flight + net-new sources through 2026-07-08 (global-stats batch) | `projects/apis/` | `projects/apis/apis-payload/clients/*.py` + `apis-payload/modules/*.md` | `core/mcp/clients/*_client.py` (prism-main parent tree; transport at `core/mcp/gs_app_proxy_negotiate.py` — verified 2026-07-07) + `prism-core/context/modules/static/{data_guides,instruments,tools}/*.md` (guide paths not yet re-verified post-reorg) | `.cursor/rules/api-clients.mdc` | `gs-proxy.md`, `api-clients.md`, `data-functions.md` §0 | `projects/apis/dev/endeavors/apis_endeavor.md` (8-session plan) |
...
|---|---|---|
| apis | per-source | 13 today (`treasury`, `treasury_direct`, `bis`, `statcan`, `bank_of_canada`, `wid`, `ai_buildout`, `ilo`, `imf`, `oecd`, `eurostat`, `boj`, `chinadata`); grows as more clients are rebuilt (target ~24) |
