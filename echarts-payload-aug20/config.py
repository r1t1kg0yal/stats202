...
# =============================================================================
# SECTION 6 -- SIZED-HEATMAP GEOMETRY
# =============================================================================
#
# A ``size_by`` heatmap encodes a second magnitude as cell AREA, drawn as
# a fraction of the cell it sits in. The floor keeps the smallest
# non-zero cell visible and hoverable; the ceiling leaves a hairline
# gutter so adjacent largest cells stay countable instead of merging into
# one block.
#
# These live here rather than in the builder because three places need
# the same two numbers: the compiler that bakes the initial fractions,
# the runtime that renormalises them after a filter, and the tests that
# pin the two together. A divergence would make a filter silently
# resize every cell.

HEATMAP_SIZE_MIN_FRAC: float = 0.18
HEATMAP_SIZE_MAX_FRAC: float = 0.94
