...
| 9+ series | aggregate/group, or `heatmap` | Too many for any panel composite |

Composite depth (`ChartSpec`, per-panel rules, patterns): §10.
...
Composites are almost always better than individuals for related data (shared x-axis, y-concept, or comparison dimension). Use individuals only for unrelated topics.
